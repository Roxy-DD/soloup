    ...
    ch: [
      {
        name: '绘画',
        ch: [
          mkLeaf('sketch', '素描', 41.3, 62, [
            ['crea', 0.5],
            ['sen', 0.5],
          ]),
          mkLeaf('oil', '油画', 18.7, 11, [
            ['crea', 0.6],
            ['sen', 0.4],
          ]),
          mkLeaf('digi', '数字绘画', 33.5, 38, [
            ['crea', 0.7],
            ['int', 0.3],
          ]),
        ],
    ...
    ch: [
      {
        name: '编程',
        ch: [
          mkLeaf('fe', '前端开发', 58.4, 71, [
            ['int', 0.6],
            ['crea', 0.4],
          ]),
          mkLeaf('rust', 'Rust', 22.1, 24, [
            ['int', 0.8],
            ['will', 0.2],
          ]),
        ],
    ...
    ch: [
      {
        name: '运动',
        ch: [
          mkLeaf('run', '跑步', 44.6, 45, [
            ['vit', 0.7],
            ['will', 0.3],
          ]),
          mkLeaf('gym', '力量训练', 15.2, 15, [
            ['vit', 0.8],
            ['will', 0.2],
          ]),
        ],
...
export const SEED_ACHIEVEMENTS: AchievementDef[] = [
  {
    ...
    points: 10,
    type: 'milestone',
    condition: { stat: 'totalDays', operator: '>=', value: 1 },
    hidden: true,
    requires: [],
    revealAt: 0.5,
  },
  {
    ...
    points: 20,
    type: 'attribute',
    condition: { stat: 'maxLitOneDay', operator: '>=', value: 2 },
    hidden: true,
    requires: ['first'],
    revealAt: 0.5,
  },
  {
    ...
    points: 30,
    type: 'milestone',
    condition: { stat: 'streak', operator: '>=', value: 7 },
    hidden: false,
    requires: [],
    revealAt: null,
  },
  {
    ...
    points: 40,
    type: 'skill',
    condition: { stat: 'maxSkillLv', operator: '>=', value: 4 },
    hidden: false,
    requires: [],
    revealAt: null,
  },
  {
    ...
    points: 100,
    type: 'milestone',
    condition: { stat: 'totalDays', operator: '>=', value: 100 },
    hidden: false,
    requires: [],
    revealAt: null,
  },
  {
    ...
    points: 120,
    type: 'attribute',
    condition: { stat: 'maxLitOneDay', operator: '>=', ref: 'totalAttrs' },
    hidden: true,
    requires: ['twin'],
    revealAt: 0.4,
  },
  {
    ...
    points: 150,
    type: 'project',
    condition: { stat: 'projectsCompleted', operator: '>=', value: 1 },
    hidden: false,
    requires: ['week7', 'dawn'],
    revealAt: null,
  },
  {
    ...
    points: 200,
    type: 'skill',
    condition: { stat: 'maxSkillLv', operator: '>=', value: 20 },
    hidden: false,
    requires: ['dawn'],
    revealAt: null,
  },
  {
    id: 'tenk',
    name: '万时之功',
    desc: '某个技能累计打卡 10,000 天',
    rarity: '传说',
    points: 300,
    type: 'skill',
    condition: { stat: 'maxSkillCheckins', operator: '>=', value: 10000 },
    hidden: false,
    requires: ['d100'],
    revealAt: null,
  },
